...
import com.study.task.quartz.common.ApiResponse;
import com.study.task.quartz.entity.domain.JobAndTrigger;
import com.study.task.quartz.entity.form.JobForm;
import com.study.task.quartz.service.JobService;
...
public class JobController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse> addJob(@Validated JobForm form) {
        try {
    ...
    public ResponseEntity<ApiResponse> cronJob(@Validated JobForm form) {
        try {
