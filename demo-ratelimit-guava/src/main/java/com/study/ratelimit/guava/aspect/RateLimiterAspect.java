package com.study.ratelimit.guava.aspect;

import com.study.ratelimit.guava.annotation.RateLimiter;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.study.ratelimit.guava.annotation.RateLimiter)")
