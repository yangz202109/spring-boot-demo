package com.study.orm.beetlsql.service;
...
import com.study.orm.beetlsql.BeetlSqlApplicationTests;
 ...
 */
@Slf4j
public class UserServiceTest extends BeetlSqlApplicationTests {
  @Autowired
  ...
  public void saveUser() {
    ...
    Assertions.assertTrue(ObjectUtil.isNotNull(user.getId()));
    log.debug("【user】= {}", user);
  }
  ...
  public void saveUserList() {
    ...
    Assertions.assertTrue(userService.getUserList().size() > 2);
  }
  ...
  public void deleteUser() {
    ...
    Assertions.assertTrue(ObjectUtil.isNull(user));
  }
  ...
  public void updateUser() {
    ...
    Assertions.assertEquals("beetlSql 修改后的名字", update.getName());
  ...
  public void getUserByPage() {
    List<User> userList = userService.getUserList();
    PageResult<User> userByPage = userService.getUserByPage(1, 5);
    Assertions.assertEquals(5, userByPage.getList().size());
    Assertions.assertEquals(userList.size(), userByPage.getTotalRow());
